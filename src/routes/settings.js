...
router.post(
  ...
  operationsLimiter,
  authenticateToken,
  asyncHandler(settingsController.refreshCache),
);
router.post(
  "/upload",
  operationsLimiter,
  ...
  storageCheck,
  upload.single("file"),
  asyncHandler(settingsController.uploadFile),
);
router.post(
  "/files/revalidate",
  operationsLimiter,
  authenticateToken,
  asyncHandler(settingsController.revalidateFile),
);
router.delete(
  "/files",
  authenticateToken,
  asyncHandler(settingsController.deleteFile),
);

router.patch(
  "/tour-state",
  authenticateToken,
  asyncHandler(settingsController.updateTourState),
);
