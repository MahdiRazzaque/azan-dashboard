  ...
  describe("getPrayers", () => {
    it("should return prayer times successfully", async () => {
      ...
      const mockCalendar = {
        "2026-03-06": {
          fajr: {
            start: "2026-03-06T05:00:00Z",
            iqamah: "2026-03-06T05:30:00Z",
          },
        },
      };
      ...
      expect(getPrayersWithNext).toHaveBeenCalledWith(
        mockConfig,
        "UTC",
        expect.any(Object),
      );
      expect(getPrayerCalendarWindow).toHaveBeenCalledWith(
        mockConfig,
        "UTC",
        {},
        expect.any(Object),
    ...
    it("should forward a valid cursorDate and direction query to the calendar service", async () => {
      ...
      const mockCalendar = {
        "2026-03-14": {
          fajr: {
            start: "2026-03-14T05:00:00Z",
            iqamah: "2026-03-14T05:30:00Z",
          },
        },
      };
      getPrayersWithNext.mockResolvedValue(mockResult);
