...
jest.mock('../../../outputs', () => {
    ...
    return {
        ...
        getSecretRequirementKeys: jest.fn(() => [{ strategyId: 'voicemonkey', key: 'token' }, { strategyId: 'voicemonkey', key: 'device' }])
    };
});
...
describe('Settings Masking Integration', () => {
    ...
    it('GET /api/settings/public - should NOT contain secrets at all', async () => {
        ...
        expect(res.body.automation.outputs.voicemonkey.params.token).toBeUndefined();
    });
