...
const storageCheck = async (req, res, next) => {
    ...
    try {
        ...
        if (!quotaCheck.success) {
            console.warn(`[StorageCheck] Quota exceeded for request: ${contentLength} bytes. Rejecting with 413.`);
            ...
            return res.status(413).json({
                ...
                message: quotaCheck.message || 'The uploaded file would exceed the storage quota.'
            });
        }
