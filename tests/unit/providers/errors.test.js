const { ProviderConnectionError, ProviderValidationError } = require('../../../src/providers/errors');

describe('Provider Errors', () => {
    describe('ProviderConnectionError', () => {
        it('should create an error with status code and source', () => {
            const error = new ProviderConnectionError('Connection failed', 503, 'Aladhan');
