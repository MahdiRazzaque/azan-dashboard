...
describe('File Upload Validation Integration', () => {
    ...
    it('POST /api/settings/upload - should show warnings for incompatible files', async () => {
        ...
        // Using regex to be safe about undefined/null codec if codec isn't provided by mock
        expect(res.body.compatibility.voicemonkey.issues[0]).toMatch(/Unsupported format/);
    });
});
