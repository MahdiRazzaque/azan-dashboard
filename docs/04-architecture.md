...
*Figure 1: High-level system architecture showing the three components and their interactions.*
...
*Figure 2: Configuration loading priority — environment variables override local overrides, which override defaults.*
...
*For step-by-step extension instructions, see the [Development Guide](./08-development-guide.md#extending-prayer-providers).*
...
*For step-by-step extension instructions, see the [Development Guide](./08-development-guide.md#adding-an-output-integration).*
...
*Figure 3: Server startup sequence showing the ordered initialisation of services.*
