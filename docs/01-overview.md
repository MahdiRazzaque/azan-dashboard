...
_Figure 1: The main Azan Dashboard displaying the prayer timetable alongside the Focus Clock countdown._
...
_Figure 2: High-level system architecture showing the three components and their interactions._

_For a detailed technical breakdown, refer to the [Architecture Documentation](./04-architecture.md)._
