  ...
  return (
    <div>
      ...
      <div data-testid="setup">
        {setupRequired ? "Setup Required" : "No Setup"}
      </div>
      <div data-testid="error">
        {connectionError ? "Connection Error" : "No Error"}
      </div>
...
describe("AuthContext", () => {
  ...
  it("should handle status requiring setup", async () => {
    ...
    await waitFor(() =>
      expect(screen.getByTestId("setup").textContent).toBe("Setup Required"),
    );
  ...
  it("should handle connection error (500)", async () => {
    ...
    await waitFor(() =>
      expect(screen.getByTestId("error").textContent).toBe("Connection Error"),
    );
  });
