...
vi.mock("../../../src/components/layout/TopControls", () => ({
  default: () => <div data-testid="top-controls">Top Controls</div>,
}));
vi.mock("../../../src/components/dashboard/PrayerCard", () => ({
  default: () => <div data-testid="prayer-card">Prayer Card</div>,
}));
vi.mock("../../../src/components/dashboard/FocusCard", () => ({
  default: () => <div data-testid="focus-card">Focus Card</div>,
}));
vi.mock("../../../src/components/common/WelcomeModal", () => ({
  default: ({ onStartTour, onSkip }) => (
    <div data-testid="welcome-modal">
      <button onClick={onStartTour}>Start</button>
