...
describe('DynamicField', () => {
  ...
  it('should render text input by default', () => {
    const param = { type: 'text', label: 'Name', placeholder: 'Enter name', description: 'Your name' };
  ...
  it('should render number input', () => {
    const param = { type: 'number', label: 'Age', placeholder: '0', constraints: { min: 0, max: 100 } };
  ...
  it('should render select input', () => {
    const param = { 
        type: 'select', 
        label: 'Color', 
        constraints: { options: [{ id: 'r', label: 'Red' }, { id: 'g', label: 'Green' }] } 
    };
  ...
  it('should validate required fields', () => {
    const param = { type: 'text', label: 'Req', constraints: { required: true } };
  ...
  it('should validate pattern constraints', () => {
    const param = { type: 'text', label: 'Pat', constraints: { pattern: '^[0-9]+$' } };
  ...
  it('should handle undefined value', () => {
    ...
    render(<DynamicField param={param} value={undefined} onChange={onChange} />);
    const input = screen.getByRole('textbox');
