...
import { AutomationStatusCell, TTSStatusCell } from '../../../../../src/components/settings/developer/StatusCells';
...
describe('StatusCells', () => {
  describe('AutomationStatusCell', () => {
    ...
    it('should show details in title', () => {
      ...
      const { container } = render(<AutomationStatusCell status="PASSED" details={details} />);
