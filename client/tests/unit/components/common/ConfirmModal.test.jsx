...
describe('ConfirmModal', () => {
  ...
  it('should call onConfirm and onClose when confirm button is clicked', () => {
    ...
    const onClose = vi.fn();
    render(<ConfirmModal {...defaultProps} onConfirm={onConfirm} onClose={onClose} confirmText="Yes" />);
  ...
  it('should call onCancel when cancel button is clicked', () => {
    ...
    render(<ConfirmModal {...defaultProps} onCancel={onCancel} cancelText="No" />);
  ...
  it('should call onClose when cancel button is clicked and onCancel is not provided', () => {
    const onClose = vi.fn();
    render(<ConfirmModal {...defaultProps} onCancel={undefined} onClose={onClose} cancelText="No" />);
    const cancelButton = screen.getByText('No');
    fireEvent.click(cancelButton);
    expect(onClose).toHaveBeenCalled();
  });
  ...
  it('should use retryText if provided', () => {
    render(<ConfirmModal {...defaultProps} onRetry={vi.fn()} retryText="Try Again" />);
