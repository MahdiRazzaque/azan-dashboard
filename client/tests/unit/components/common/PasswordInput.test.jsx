...
describe("PasswordInput", () => {
  ...
  it('should show "Weak" strength for 2 or fewer passed checks', () => {
    const { container } = render(
      <PasswordInput {...defaultProps} showStrength={true} value="abc" />,
    );
  ...
  it('should show "Medium" strength for 3 or 4 passed checks', () => {
    render(
      <PasswordInput {...defaultProps} showStrength={true} value="Abc1" />,
    );
  ...
  it('should show "Strong" strength for all 5 passed checks', () => {
    ...
    render(
      <PasswordInput {...defaultProps} showStrength={true} value="Abcdef1!" />,
    );
  ...
  it("should correctly display requirement checks", () => {
    const { container } = render(
      <PasswordInput {...defaultProps} showStrength={true} value="A" />,
    );
