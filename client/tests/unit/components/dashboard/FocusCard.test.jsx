...
describe("FocusCard", () => {
  ...
  it("should format countdown in digital mode", () => {
    useClientPreferences.mockReturnValue({
      preferences: {
        ...mockPreferences,
        appearance: { ...mockPreferences.appearance, countdownMode: "digital" },
      },
    });
    render(<FocusCard {...defaultProps} />);
  ...
  it("should format countdown in minimal mode", () => {
    useClientPreferences.mockReturnValue({
      preferences: {
        ...mockPreferences,
        appearance: { ...mockPreferences.appearance, countdownMode: "minimal" },
      },
    });
    render(<FocusCard {...defaultProps} />);
