      ...
      <div className="w-full max-w-md space-y-8 bg-app-card/30 p-8 rounded-2xl border border-app-border backdrop-blur-xl">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-app-text tracking-tight">
            Welcome to Azan Dashboard
          </h1>
          <p className="text-app-dim text-sm">
            Please set an administrative password to secure your dashboard.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-app-dim mb-1 ml-1 uppercase tracking-wider">
                New Password
              </label>
              <PasswordInput
                value={password}
