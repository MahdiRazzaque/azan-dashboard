...
export default function DynamicField({ param, value, onChange }) {
  ...
  const commonClasses =
    "w-full bg-app-card border border-app-border rounded p-2.5 text-app-text focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500";
        ...
        return (
          <select
            ...
            onChange={(e) => {
              ...
              const option = param.constraints?.options?.find(
                (o) => String(o.id) === val,
              );
