      ...
      <div className="bg-app-card/40 border border-app-border rounded-xl p-6">
        ...
        <div className="flex flex-col gap-3">
          <ActionButton
            ...
            subtext={
              systemHealth.tts
                ? "Rebuilds audio files for today's cache"
                : "TTS Service Offline"
            }
            icon={RefreshCw}
            color="text-blue-400"
            ...
            onClick={() =>
              callSystemAction("tts", "/api/system/regenerate-tts")
            }
          />
          <ActionButton
            ...
            onClick={() =>
              callSystemAction("scheduler", "/api/system/restart-scheduler")
            }
          />
          <ActionButton
            ...
            disabled={loading !== null}
            onClick={() =>
              callSystemAction("config", "/api/settings/refresh-cache")
            }
          />
          <ActionButton
            ...
            disabled={loading !== null}
            onClick={() =>
              callSystemAction("tempCleanup", "/api/system/cleanup-temp-tts")
            }
          />
        </div>
      </div>
            ...
            <tbody className="divide-y divide-app-border/50">
              {jobs.length === 0 ? (
                <tr>
                  <td
                    colSpan="3"
                    className="px-4 py-8 text-center text-app-dim text-xs italic"
                  >
                ...
                jobs.map((job, i) => (
                  <tr
                    key={i}
                    className="group hover:bg-app-card/40 transition-colors"
                  >
                    ...
                    <td className="px-4 py-3 text-app-dim font-mono text-xs">
                      {job.nextInvocation
                        ? new Date(job.nextInvocation).toLocaleTimeString()
                        : "Pending"}
                    </td>
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          !jobStatuses[job.name] &&
                            "hover:bg-app-bg text-app-dim hover:text-emerald-500",
